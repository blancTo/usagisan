  ...
  return (
    <>
      <LayoutNew imageName={imageName}>
        ...
        <p>
          <span className="underline bg-gray">ペレットは総合栄養食ではなく「サプリ」程度に思って与えてください。</span>
        </p>
        <p>歯の伸び過ぎを防ぐ一番の方法は牧草好きな子にすることです。</p>
        <p>
          <span className="underline bg-gray">与える必要のない【ショ糖・果物・野菜・種子類・コーンスターチなどが主原料のサプリ・酵母、酵素・乳酸菌など】物を与えないことが大切です。</span>
        </p>
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: {
            ...
            description: "うさぎペットホテルをお探しなら【ウサギさん】へお越しください。JR山手線鶯谷駅から５分の場所にあります。午前中からお預け可能で長期利用もOKで安心安全です。かわいいチンチラさんの販売もしております。｜チンチラの飼育について",
...
export const Head = () => (
  <>
    <body id="pagetop" />
    <Seo title="チンチラの飼育について" description2="チンチラ専門店（うさぎ専門店）うさぎさん（ペットホテル＆うさカフェ（チンチラカフェ））は、JR山手線鶯谷駅から５分の場所にある、午前中からお預け可能で長期利用も可能な格安ペットホテル・チンチラカフェ・うさカフェをはじめ、純血種のうさぎ・チンチラを販売もしております。" article={true} />
    <script type="application/ld+json">{JSON.stringify(jsonLd)}</script>
  </>
)

export default ChinchillaRearing
