  ...
  return (
    ...
    <div id="main-content" className="flex-wrap">
        <div className="main-cont">
            <h3><img src="/images/price_tit.jpg" alt="" /></h3>
            <h3>当うさぎカフェは時間制です</h3>
          ...
          <table className="legal_notice">
            ...
            <p>※ドリンクのおかわりはお気軽に申し付け下さい<br />
            ※料金は税別です。但しサービスドリンク不要の場合10%割引します。<br />
            ＊プレーリードッグ・チンチラ・アルマジロ・マーモットとの触れ合いも可能です</p>
            <p>＊当店は時間制です。予約時間3分前から入場可能です。<br />
            ※18歳以下のお客様の場合、カフェのご利用は必ず保護者同伴でお願い致します。</p>
            

        <h3><img src="/images/price_tit01.jpg" width={698} height={82} alt="ペットホテルのご利用料金" /></h3>
        ...
        <table className="legal_notice">
              ...
              <ul>
                ...
                <li>床材はALL牧草、ケージ全面に牧草を敷き詰めさせていただきます。（排便数が250個以上出ているうさぎさんが対象です）＊望まれる場合はお申し付けください</li>
                <li>樹脂フロアの床材もご用意させて頂いております。</li>
                <li>小動物のみのお預かりとさせていただきます。</li>
                <li>当日に感染症の恐れが認められた場合や健康状態が良好と判断できない場合はお断りさせていただくことがあります。<br />ご心配な方や、体調が悪いウサギさんは予め獣医師に診察をしてもらってください。<br />
                  （５歳以上のウサギさんは獣医師が一カ月以内に発行した健康診断証明書が必要となります。無くても基本お預かりしますが割引は適用出来かねます。）</li>
                <li>薬の投与等はお受けできませんのでご了承ください。</li>
                <li>ご予約時間を15分以上超過する場合は、お手数ですがinfo@usagisan.infoまたは、<br />
                  080-4383-7060まで連絡ください。</li>
                <li>午前8時からお預かり可能です。</li>
                <li>割引料金はお客様への通知なしに改定しホームページにアップされている料金システムを採用させて頂きます。</li>
                <li>キャンセル料、予約時から3日前ご契約料金の50%、前日・当日はご契約料金の100%頂戴いたします。</li>
                <li>当店から飼育管理者様に消化器症候群(ガス)・体調不良の可能性があることを告げたのにも関わらず病院へ行くことを拒否された場合ご宿泊費とは別に特別料金を請求させていただきます。</li>
                <li>午後12時以降のお引取りは半日分、15時以降は1日分のご宿泊費用を頂戴します。</li>
                <li>午前8時前、午後20時以降、年末年始(12月31日から1月1日)のチェックイン・チェックアウトは基本可能ですが1日分のご宿泊費を頂戴いたします。</li>
            ...
            <h3 className="sub_title">ペットホテルご利用にあたって</h3>
              ...
              <p><img src="/images/price_img02.jpg" width={61} height={19} alt="免責事項" /><br />以下の場合、当店では責任を負いかねます。</p>

              <ol>
                <li>お客様からのお申し出がなく発生した全ての病気、怪我、死亡。</li>
                <li>お預かり後に発見、発生した全ての病気、怪我。特に鬱滞、ガス、食滞、毛球症の発見</li>
                <li>当店の不可抗力による突発性による事故（天災による自然被害・第三者による被害・事故など） 不慮の事故・高齢・持病・特異体質に基づく発病・死亡・ケガ・突然死などが発生した場合、又いかなる事情に置いても保証・賠償、損害補償などのいかなる請求は一切お受けできませんので予めご了承下さい。</li>
              </ol>
            
          
        <p><img src="/images/price_img01.jpg" width={73} height={19} alt="お得情報" /></p>
        
        <p className="red bold">【送迎費無料】2ケ月以上ご利用のお客様に限り無料で送迎させていただきます。<br />
        チェックイン時、普段使用されている給水ボトルは必ずお持ち下さい。</p>

        <div className="price10"><img src="/images/price_img03.jpg" width={721} height={201} alt="" /></div>
