...
const jsonLd = {
  ...
  "@graph": [
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: {
            ...
            description: "うさぎのペットホテル＆うさぎカフェは、JR山手線鶯谷駅から徒歩5分の場所にあります。愛されるうさぎさんたちの安心・安全・快適な宿泊環境を提供しています。併設のうさぎカフェでは、愛らしいうさぎさんたちと触れ合いながら、お茶やスイーツを楽しむことができます。｜料金システム",
    ...
    },
    {
      ...
      url: "https://usagisan.info/price/",
      name: "うさぎペットホテル・うさぎカフェ【うさぎさん】｜料金システム",
      description: "うさぎペットホテルをお探しなら【ウサギさん】へお越しください。JR山手線鶯谷駅から５分の場所にあります。午前中からお預け可能で長期利用もOKで安心安全です。かわいいチンチラさんの販売もしております。｜料金システム",
      inLanguage: "ja",
      isPartOf: {
...
export const Head = () => (
  <>
    <body id="pagetop" />
    <Seo title="料金システム" description2="うさぎペットホテル、うさぎカフェ、チンチラ専門店をお探しなら【ウサギさん】へお越しください。こちらは当店の紹介ページになります。営業時間、受付時間等はこちらのページをご確認下さい。" article={true} />
