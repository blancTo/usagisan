...
const ChinchillaImportance = ({ data }) => {
  ...
  return (
    <>
      <LayoutNew imageName={imageName}>
        ...
        <div className="box_cream">パパイヤリーフ・オオバコ・タンポポ・クコの葉・すいか・齧り木（時期によって種類は異なります）</div>
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: {
            ...
            description: "うさぎペットホテルをお探しなら【ウサギさん】へお越しください。JR山手線鶯谷駅から５分の場所にあります。午前中からお預け可能で長期利用もOKで安心安全です。かわいいチンチラさんの販売もしております。｜チンチラのご宿泊について重要視していること",
...
export const Head = () => (
  <>
    <body id="pagetop" />
    <Seo title="チンチラのご宿泊について重要視していること" description2="チンチラ専門店（うさぎ専門店）うさぎさん（ペットホテル＆うさカフェ（チンチラカフェ））は、JR山手線鶯谷駅から５分の場所にある、午前中からお預け可能で長期利用も可能な格安ペットホテル・チンチラカフェ・うさカフェをはじめ、純血種のうさぎ・チンチラを販売もしております。" article={true} />
    <script type="application/ld+json">{JSON.stringify(jsonLd)}</script>
  </>
)

export default ChinchillaImportance
