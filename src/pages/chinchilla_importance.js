      ...
      <Layout>
        ...
        <div id="main-content" className="flex-wrap">
          <div className="main-cont">
              <h3><img src="/images/chinchilla_tit.png" width={698} alt="チンチラのご宿泊について重要視していること" /></h3>
              <p className='blue bold'>当店ではご宿泊していただく子達が安心して生活出来るようパーソナルスペースの環境作りを重要視しています。<br />
            当店ではチンチラが安心して生活できるよう以下のことを徹底しています。</p>
          ...
          <p>当店では低カロリーで高繊維質なチモシーをたっぷり食べて頂きたいと考えています。チモシーはお腹の健康維持だけではなく歯の研磨を助け不正咬合を抑制する効果が期待できます。</p>
          <p className="title03">チンチラの砂について・・・</p>
          <p>当店ではチンチラ専用の砂を使用しています。当店では超微粒子、高温殺菌した珪砂を使用しチンチラの皮脂を確り落としてくれるものです。指定の砂がある場合は持参していただきたいです。</p>
          <p className="title03">ペレットについて・・・</p>
          <p>当店で使用しているペレットは「チンチラセレクションプロ」を使用しています。<br />
            チンチラセレクションプロは牧草（チモシー）を主原料にしているペレットです。粗繊維も23％と多く、乳酸菌EC12株、おおばこ、たんぽぽ、ハーブ、ベータグルカン、消化酵素を配合しているものです。<br />
            粗繊維が豊富なため「毛球」や「食滞」予防にもなります。<br />
            また小麦を使わないことで消化器系の負担が少ないものを使用しています。唯一のデメリットとしてあげれるのは「嗜好性が高くない」ことです。これは最大のメリットでもありますが、嗜好性の高いペレットを常時給餌している場合は食べない可能性があるので主原料が「アルファルファ」の場合は持参して頂くようお願いしています。</p>
          <p>当然すべてご宿泊費に含まれています。その他無料サービスも多くあります。</p>
          <p>お客様のご家族が使用している器具を使用することも可能です。その際はあらかじめ教えていただけると助かります。</p>
          </div>
