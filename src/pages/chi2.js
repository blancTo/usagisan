      ...
      <LayoutNew imageName={imageName}>
        ...
        <table className="chi_table">
          <tbody>
            ...
            <tr>
              <th colSpan={4} width={450} height={26} align="center">
                食餌量
              </th>
            </tr>
            <tr>
              <td colSpan={4} width={450} height={50}>
                基本、牧草と適量(別枠)のペレット以外は与えないでください。
                <br />
                <br />
                牧草(チモシー)を中心に給餌する(総給餌量の9割が理想)
                <br />
        ...
        <table className="chi_table">
          <tbody>
            ...
            <tr>
              <td colSpan={4} width={300} height={50} className="border_b ">
                <a href="#1">ドライフルーツ</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colSpan={4} width={300} height={50}>
                <a href="#3">オートミール(えん麦、もみ殻)</a>
              </td>
            </tr>
          </tbody>
        </table>
          ...
          <table className="chi_table">
            <tbody>
              <tr>
                ...
                <td width={150} height={26} className="border_b ">
                  25～30g/日
                </td>
              </tr>
              <tr>
        ...
        <p>
          ...
          <br />
          <br />
          ■糞便を指先で潰した際、牧草が粉砕された様な便が理想
          <br />
          ■潰れない、かたい場合は、ペレット量を見直してください。
          <br />
          ■換毛期に毛が混じりますが、繋がるのは危険信号です。
          <br />
          ■大きさがまばらな場合、要注意
          <br />
          ■軟便・下痢は一秒でも早く獣医師に診せてください。
          <br />
          <br />
          <br />
...
export const Head = () => (
  <>
    <body id="pagetop" />
    <Seo title="うさぎ｜げっ歯目｜うさぎ・チンチラ専門店" description2="チンチラ専門店（うさぎ専門店）うさぎさん（ペットホテル＆うさカフェ（チンチラカフェ））は、JR山手線鶯谷駅から５分の場所にある、午前中からお預け可能で長期利用も可能な格安ペットホテル・チンチラカフェ・うさカフェをはじめ、純血種のうさぎ・チンチラを販売もしております。" article={true} />
