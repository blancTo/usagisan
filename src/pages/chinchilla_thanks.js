...
const ChinchillaThanks = () => {
  const imageName = "toiawase_img"
  return (
    <>
      <LayoutNew imageName={imageName}>
        <h3 className="form_maintitle">「うさぎ・チンチラ専門店」へのお問い合わせありがとうございました</h3>
        <p>
          「うさぎ・チンチラ専門店」へのお問い合わせありがとうございました。
          <br />
...
const jsonLd = {
  ...
  "@graph": [
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: {
            ...
            name: "「うさぎ・チンチラ専門店」へのお問い合わせありがとうございました｜うさぎペットホテル・うさぎカフェ【うさぎさん】｜ペットホテル",
            description: "「うさぎ・チンチラ専門店」へのお問い合わせありがとうございました。うさぎペットホテルをお探しなら【ウサギさん】へお越しください。JR山手線鶯谷駅から５分の場所にあります。午前中からお預け可能で長期利用もOKで安心安全です。かわいいチンチラさんの販売もしております。｜ペットホテル",
    ...
    },
    {
      ...
      url: "https://usagisan.info/hotel_thanks/",
      name: "「うさぎ・チンチラ専門店」へのお問い合わせありがとうございました｜うさぎペットホテル・うさぎカフェ【うさぎさん】｜ペットホテル",
      description: "「うさぎ・チンチラ専門店」へのお問い合わせありがとうございました。JR山手線鶯谷駅から５分の場所にあります。午前中からお預け可能で長期利用もOKで安心安全です。かわいいチンチラさんの販売もしております。",
      inLanguage: "ja",
      isPartOf: {
...
export default ChinchillaThanks
