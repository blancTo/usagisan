    ...
    <>
      <LayoutNew imageName={imageName}>
        ...
        <p className="box_cream bold center">
          <img src="/images/jyuyo_pic01.png" width={76} height={51} alt="" /> 換毛期だけではなく日頃のブラッシングが重要！
        </p>
        ...
        <div className="rabbit_list01">
          <ul>
            ...
            <li>
              <FontAwesomeIcon icon={faCheck} /> ブラッシングを毎日行うことで体重の減少、また体調の変化に気づきやすくなる。
            </li>
            <li>
              <FontAwesomeIcon icon={faCheck} /> ブラッシングに毎日行うことで大量に毛が抜ける換毛期、長い時間ブラッシングしても嫌がらなくなる。
            </li>
          </ul>
        </div>
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: {
            ...
            description: "うさぎペットホテルをお探しなら【ウサギさん】へお越しください。JR山手線鶯谷駅から５分の場所にあります。午前中からお預け可能で長期利用もOKで安心安全です。かわいいチンチラさんの販売もしております。｜うさぎの飼育　グルーミング",
...
export const Head = () => (
  <>
    <body id="pagetop" />
    <Seo title="うさぎの飼育　グルーミング" description2="チンチラ専門店（うさぎ専門店）うさぎさん（ペットホテル＆うさカフェ（チンチラカフェ））は、JR山手線鶯谷駅から５分の場所にある、午前中からお預け可能で長期利用も可能な格安ペットホテル・チンチラカフェ・うさカフェをはじめ、純血種のうさぎ・チンチラを販売もしております。" article={true} />
