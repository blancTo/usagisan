  ...
  return (
    ...
    <div id="main-content" className="flex-wrap">
        <div className="main-cont">
            <h3><img src="/images/vegetable_tit.png" width={698} alt="うさぎの飼育　生野菜の給餌について" /></h3>
            <p class="center"><img src="/images/vegetable_pic01.jpg" alt="" width="100%" /></p>
   
   <p>うさぎ・モルモットなどの完全草食動物を飼育する上で生野菜は本当に必要なのか？<br />
   生野菜は必要だという人もいれば、特に必要ないという人もいます。<br />
   獣医師によっても大きく見解が分かれます。<br />
   個人的な見解だけでいえば過剰に与えなければ問題ないと思います。<br />
   必要だという方の多くは嗜好性だけではなく生野菜に含まれる食物酵素を摂取することが出来、摂取することで消化酵素が増え、食物の消化や代謝を助けてくれるのが理由の一つだと言えますが生野菜の栄養素（酵素・ビタミン・ミネラル）は生のまま摂取しても吸収率が悪いのも事実。<br />
   草食動物の主食である牧草（チモシー）に含まれている量が少ないﾋﾞﾀﾐﾝAを補うために人参などを与えているという方もいますが、人参などに多く含まれるビタミンAは脂溶性ビタミといわれ生のまま摂取しても殆ど栄養を吸収することが出来ません。<br />
   生野菜から果物に話は変わりますが、ビタミンB6・ビタミンB12・葉酸・ビオチンの機能性成分はイチゴ・バナナに含まれていることからイチゴ・バナナなどを与えている人がいますがこれは腸性毒血症を発症する可能性が高まるので過剰に与えるのはオススメできません。<br />
   与える際の目安として一か月に一回人差し指の爪くらいの量なら問題ないと思います。（理由：単糖類はクロストリジウム菌が毒素を作りだすときに必要な栄養素になるからです）<br />
   個人的に懸念しているのは、生野菜を過剰に与えると毎日の飲水量が変化する為、体調管理が難しくなる可能性があります。<br />
   一日与えるとしても５グラム程度の少量にするのが好ましいと思います。<br />
   参考までに野菜の栄養価について示した表です。（五訂食品成分表）</p>
   
<table class="vagetable">
<thead>
<tr>
<th>&nbsp;</th>
<th>水分(g)</th>
...
<p>上記の表を見ていただければ分かると思いますが、生野菜の８割から９割は水分です。<br />
主食である牧草（チモシー）の食物繊維は３０％～４０％です。<br />
雑食動物からしたら生野菜に含まれる食物繊維の量は魅力的かもしれませんが、完全草食の彼らにしてみたら食物繊維は入ってないようなものだと言っても過言ではありません。<br />
副食として食に彩を添えるという意味では良いと思います。</p>
        </div>
      ...
      "itemListElement":[
        ...
        },
        {
          ...
          "item":{
            ...
            "description":"埼玉県のペット火葬・葬儀のことなら「愛心ペットセレモニー埼玉」｜猫・犬はもちろん、うさぎや小鳥の火葬・葬儀も対応。｜うさぎの飼育　生野菜の給餌について",
