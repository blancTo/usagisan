          ...
          <div className="main-cont">
            <div className="smp center">
              ...
              <Link to="/contact_hotel.html">
                <StaticImage
                  src="../images/hotel_contact_btn.png"
                  alt="ペットホテルのお問い合わせ・ご予約はこちらから"
                />
              </Link>
              <Link to="/contact_cafe.html">
                <StaticImage
                  src="../images/cafe_contact_btn.png"
                  alt="うさぎカフェ問い合わせ・ご予約はこちらから"
                />
              </Link>
              <a href="tel:08043837060">
                <StaticImage
                  src="../images/tel_btn.png"
                  alt="お見積などのお問い合わせは携帯電話まで"
                />
              </a>
            </div>
            ...
            <div className="center">
              <Link to="/fremishgiant_page.html">
                <StaticImage
                  src="../images/fre_bn.jpg"
                  alt="フレッシュジャイアントの販売はこちら"
                />
              </Link>
            </div>
            ...
            <ul>
              <li>
                <span>
                  ペットホテルうさぎさんは、JR山手線、鶯谷駅南口から徒歩5分、日比谷線、入谷駅から徒歩7分の場所に
                  ある完全予約制のペットホテルです。
                </span>
              </li>
              <li>
                <span>
                  当店は一羽一羽のウサギさんが心地よく、ゆっくりと自宅に居るときのように安心して過ごせるよう、室内の環境に配慮している為、完全予約制とさせて頂いております。
                </span>
              </li>
              <li>
                <span>
                  ウサギさんが快適に過ごせるようお預かりしたウサギさんはすべて大型ケージでお預かりさせていただきます。またハリネズミ(ピグミーヘッジホッグ)・チンチラ・デグー・モルモット・ハムスター・ジリスは専用ケージでお預かりします。
                </span>
              </li>
              <li>
                <span>
                  大切にお預かりいたしますので、飼い主様はもちろん、ホテルが初めてという、ウサギさんも安心してご利用いただけます。
                </span>
              </li>
              <li>
                <span>
                  健康状態の良いウサギさんのみお預かりさせていただきます。(チェックイン時、必ず排便を持参してください)
                </span>
              </li>
              <li>
                <span>
                  ペットホテルご利用時、ウサギさんの爪切り、グルーミングはサービスで行っております。ご希望の際はお申し付けください。
                </span>
              </li>
              <li>
                <span>
                  小動物であれば基本お預かりさせていただきます。(うさぎ・チンチラ・デグー・ハムスター・ジリス・モルモット・ハリネズミ)
                </span>
              </li>
              <li>
                <span>
                  キャリーバックは無料でお預かりさせていただきます。不潔な場合は、清掃費(1,100円)頂戴します。
                </span>
              </li>
            </ul>
            ...
            <div className="top_faq_box">
              ...
              <div className="content">
                <FontAwesomeIcon icon={faA} />
                <p>
                  基本的に可能です。予約状況によりお断りさせていただく場合がございます。
                </p>
              </div>
              ...
              <div className="content">
                <FontAwesomeIcon icon={faA} />
                <p>
                  満室でなければ可能です。※延長料金はお引き取りの際にご請求させていただきます。
                </p>
              </div>
            ...
            <ul>
              ...
              <li>
                <span>
                  スタンダードレッキス・ミニレッキス・ネザーランドドワーフ・ホーランドロップ・もふもふのチンチラさん珍獣アルマジロが皆様をお待ちしております。
                </span>
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                <br />
                <a
                  href="https://dogcatch.net/wanwannavi/tokyotonai-dobutsukafue-osusume/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <div className="access_box">
              ...
              <p>
                鶯谷駅南口からの道のりのポイントを写真で紹介しています。下記の写真に触るとスライドしていきます。
              </p>
              ...
              >
                ...
                <SwiperSlide>
                  <StaticImage
                    src="../images/ugu-03.jpg"
                    alt="ホテルシャーウッド側の坂を下ります"
                  />
                ...
                <SwiperSlide>
                  <StaticImage
                    src="../images/ugu-04.jpg"
                    alt="坂を下ったところの横断歩道を渡ります"
                  />
                ...
                <SwiperSlide>
                  <StaticImage
                    src="../images/ugu-05.jpg"
                    alt="横断歩道を渡り終えたら、左に曲がります"
                  />
                ...
                <SwiperSlide>
                  <StaticImage
                    src="../images/ugu-06.jpg"
                    alt="左手側に東横インが見えます。そのまま30メートル程直進してください"
                  />
                  <p>
                    6.左手側に東横インが見えます。そのまま30メートル程直進してください
                  </p>
                </SwiperSlide>
                <SwiperSlide>
                  <StaticImage
                    src="../images/ugu-07.jpg"
                    alt="左手にカンデオホテルズ上野さんが見えましたら、右に曲がります"
                  />
                  <p>
                    7.左手にカンデオホテルズ上野さんが見えましたら、右に曲がります
                  </p>
                </SwiperSlide>
                <SwiperSlide>
                  <StaticImage
                    src="../images/ugu-08.jpg"
                    alt="この道を曲がり10メートルで当店の入り口です"
                  />
                  <p>8.この道を曲がり10メートルで当店の入り口です</p>
                </SwiperSlide>
                <SwiperSlide>
                  <StaticImage
                    src="../images/ugu-09.jpg"
                    alt="右手の角にある茶色いお店になります"
                  />
              ...
              <p>
                入谷駅２番出口からの道のりのポイントを写真で紹介しています。下記の写真を触るとスライドしていきます。
              </p>
              ...
              >
                ...
                <SwiperSlide>
                  <StaticImage
                    src="../images/iri-02.jpg"
                    alt="右手に銀だこさん、みずほ銀行のある道を進みます"
                  />
                  <p>2.右手に銀だこさん、みずほ銀行のある道を進みます</p>
                </SwiperSlide>
                <SwiperSlide>
                  <StaticImage
                    src="../images/iri-03.jpg"
                    alt="根岸一丁目交差点をそのまま真っ直ぐ進みます"
                  />
                  <p>3.根岸一丁目交差点をそのまま真っ直ぐ進みます</p>
                </SwiperSlide>
                <SwiperSlide>
                  <StaticImage
                    src="../images/iri-04.jpg"
                    alt="そのまま道なりに進みます"
                  />
                  <p>4.そのまま道なりに進みます</p>
                </SwiperSlide>
                <SwiperSlide>
                  <StaticImage
                    src="../images/iri-05.jpg"
                    alt="左手側に東横インが見えます。そのまま30メートル程直進してください"
                  />
                  <p>
                    5.左手側に東横インが見えます。そのまま30メートル程直進してください
                  </p>
                </SwiperSlide>
                <SwiperSlide>
                  <StaticImage
                    src="../images/iri-06.jpg"
                    alt="左手にカンデオホテルズ上野さんが見えましたら、右に曲がります"
                  />
                  <p>
                    6.左手にカンデオホテルズ上野さんが見えましたら、右に曲がります
                  </p>
                </SwiperSlide>
                <SwiperSlide>
                  <StaticImage
                    src="../images/iri-07.jpg"
                    alt="この道を曲がり10メートルで当店の入り口です"
                  />
  ...
  "@graph": [
    {
      ...
      description:
        "うさぎのペットホテル＆うさぎカフェは、JR山手線鶯谷駅から徒歩5分の場所にあります。愛されるうさぎさんたちの安心・安全・快適な宿泊環境を提供しています。併設のうさぎカフェでは、愛らしいうさぎさんたちと触れ合いながら、お茶やスイーツを楽しむことができます。",
      address: {
        "@type": "PostalAddress",
      ...
      sameAs: [
        "https://twitter.com/7463Ican",
        "https://www.facebook.com/pettohoteru.usagisan",
      ],
    },
    {
      "@type": "BreadcrumbList",
